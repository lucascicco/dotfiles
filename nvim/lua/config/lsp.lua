...
local lsp_disable_format = {
  ...
  terraformls = true, -- format via `terraform fmt`, not LSP
  tsserver = true,
}
...
vim.api.nvim_create_autocmd("LspAttach", {
  ...
  callback = function(args)
    ...
    -- yamlls must not attach to helm buffers — helm_ls handles them and delegates
    -- yaml-within-helm back to yamlls internally. Dual attachment causes conflicts.
...
local servers = {
  ...
  "groovyls", -- https://github.com/prominic/groovy-language-server (JAR built by bootstrap)
